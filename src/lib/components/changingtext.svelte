<script lang="ts">
	...
	const texts = [
		...
		"  I graduated from Data  Science and Machine Learning program at Red River College in 2024 with GPA 4.46/4.5. Prior to that, I earned Master's degree of Electronic Engineering.",
		...
		'  My tech stack includes Python, Deep Learning,   Unsupervised Learning,   TypeScript, React, Nextjs, Svelte, Express, SQL,  PHP, Aws, Azure, GCP, CI/CD and more...'
	];
	...
	function updateText() {
		...
		setTimeout(updateText, deleting ? 30 : 150);
	}
